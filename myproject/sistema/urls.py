...
urlpatterns = [
    ...
    path('reactivarMiembro/<int:dni>',reactivarMiembro, name='reactivarMiembro'),
    ...
    path("auditoriaAsistencia/", auditoriaAsistencia, name="auditoriaAsistencia"),
    path("auditoriaUsuario/", auditoriaUsuario, name="auditoriaUsuario"),
    ...
    path("auditoria_detalles_asistencia/<int:id_asistencia>/<int:id_auditoria>", auditoria_detalles_asistencia, name="auditoria_detalles_asistencia"),
    path("auditoria_detalles_usuario/<int:id_usuario>/<int:id_auditoria>", auditoria_detalles_usuario, name="auditoria_detalles_usuario"),
